                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-4">
                            ...
                            <p className='footer-text'>Бизнесингизни ривожлантиринг, бухгалтерияни бизга топширинг!</p>
                        </div>
                        <div className="col-12 col-md-4">
                            <ul className='logos'>
                        ...
                        <div className="col-12 col-md-4">
                            <div className="footer-contact">
                                ...
                                <p><a href="#">Чилонзор тумани, Чилонзор кўчаси, 4 уй</a></p>
                            </div>
                        </div>
                    </div>
                    <div className="row mt-4">
                        ...
                        <div className="col-12">
                            <div className="footer-footer">
                                ...
                                Ўзбекистон бўйлаб қулай бухгалтерия хизматлари.
                                </p>
                            </div>
                        </div>
                    </div>
